...
备注：
*********************************************************************/
extern "C" bool ModuleProtocol_Packet_Comm(TCHAR* ptszMsgBuffer, int* pInt_MsgLen, int nCode = 0, LPCXSTR lpszMsgBuffer = NULL, LPCXSTR lpszToken = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" bool ModuleProtocol_Parse_HTTPForward(LPCXSTR lpszMsgBuffer, int nMsgLen, TCHAR * ptszAVUrl = NULL);