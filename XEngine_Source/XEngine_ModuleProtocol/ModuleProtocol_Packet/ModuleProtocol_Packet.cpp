...
备注：
*********************************************************************/
bool CModuleProtocol_Packet::ModuleProtocol_Packet_Comm(TCHAR* ptszMsgBuffer, int* pInt_MsgLen, int nCode /* = 0 */, LPCXSTR lpszMsgBuffer /* = NULL */, LPCXSTR lpszToken /* = NULL */)
{
