...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_Create(LPCXSTR lpszSMSAddr, XNETHANDLE xhFLVStream)
{
	...
	//是否存在
	st_Locker.lock();
	unordered_map<xstring, PUSHSTREAM_PACKET *>::iterator stl_MapIterator = stl_MapPushStream.find(lpszSMSAddr);
	if (stl_MapIterator == stl_MapPushStream.end())
	{
		//不存在就创建
		stl_MapPushStream.insert(make_pair(lpszSMSAddr, pSt_Packet));
	}
	else
	{
		//存在
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_Destroy(LPCXSTR lpszSMSAddr)
{
	Session_IsErrorOccur = false;
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_GetStreamForAddr(LPCXSTR lpszSMSAddr, XNETHANDLE* pxhFLVStream)
{
	Session_IsErrorOccur = false;
	...
	*pxhFLVStream = stl_MapIterator->second->xhFLVStream;
	st_Locker.unlock_shared();
	return true;
}
/********************************************************************
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_Send(LPCXSTR lpszSMSAddr, LPCXSTR lpszMsgBuffer, int nMsgLen, int nAVType, int nFrameType)
{
	Session_IsErrorOccur = false;
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_Recv(LPCXSTR lpszSMSAddr, XCHAR** pptszMsgBuffer, int* pInt_MsgLen, int* pInt_AVType, int* pInt_FrameType)
{
	Session_IsErrorOccur = false;
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_ClientInsert(LPCXSTR lpszSMSAddr, LPCXSTR lpszClientAddr)
{
	Session_IsErrorOccur = false;
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_ClientDelete(LPCXSTR lpszSMSAddr, LPCXSTR lpszClientAddr)
{
	Session_IsErrorOccur = false;
	...
	{
		if (0 == _tcsxnicmp(lpszClientAddr, stl_ListIterator->c_str(), _tcsxlen(lpszClientAddr)))
		{
...
备注：
*********************************************************************/
bool CModuleSession_PushStream::ModuleSession_PushStream_ClientList(LPCXSTR lpszSMSAddr, list<xstring> *pStl_ListClient)
{
	Session_IsErrorOccur = false;
