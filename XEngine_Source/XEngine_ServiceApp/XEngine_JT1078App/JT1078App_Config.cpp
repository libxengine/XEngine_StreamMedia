...
bool JT1078App_Service_Parament(int argc, char** argv)
{
	...
	LPCXSTR lpszJT1078Cfg = _X("./XEngine_Config/XEngine_JT1078Config.json");
...
{
	printf(_X("--------------------------启动参数帮助开始--------------------------\n"));
	printf(_X("流媒体服务启动参数：程序 参数 参数值，参数是区分大小写的。如果不指定将会加载默认的./XEngine_Config/XEngine_JT1078Config.json配置文件里面的参数\n"));
